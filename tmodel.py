...
if __name__ == '__main__':
    ...
    # model_list, coherence_values, perplexity_values = compute_coherence_values(dictionary=id2word, corpus=corpus, texts=data_lemmatized,
    #                                                         start=start, limit=limit, step=step)
    #
    # #Сохраняем модели
    # with open('model_list.pickle', 'wb') as f:
    #     pickle.dump(model_list, f)
    # with open('coherence_values.pickle', 'wb') as f:
    #     pickle.dump(coherence_values, f)
    # with open('perplexity_values.pickle', 'wb') as f:
    #     pickle.dump(perplexity_values, f)


    with open('model_list.pickle', 'rb') as f:
        model_list = pickle.load(f)
    with open('coherence_values.pickle', 'rb') as f:
        coherence_values = pickle.load(f)
    with open('perplexity_values.pickle', 'rb') as f:
    ...
    fig=plt.plot(x, perplexity_values)
    plt.xlabel("Количество тем")
    ...
    model_list[optimal_topic_num-2].print_topics()
    ...
    vis = pyLDAvis.gensim.prepare(model_list[optimal_topic_num-2], corpus, id2word)
